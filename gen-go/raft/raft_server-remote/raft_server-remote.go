...
var _ = raft.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  AppendEntriesResp AppendEntries(AppendEntriesReq req)")
  fmt.Fprintln(os.Stderr, "  RequestVoteResp RequestVote(RequestVoteReq req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := raft.NewRaftServerClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "AppendEntries":
    ...
    argvalue0 := raft.NewAppendEntriesReq()
  ...
  case "RequestVote":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "RequestVote requires 1 args")
      flag.Usage()
    }
    arg18 := flag.Arg(1)
    ...
    argvalue0 := raft.NewRequestVoteReq()
    ...
    value0 := argvalue0
    fmt.Print(client.RequestVote(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
